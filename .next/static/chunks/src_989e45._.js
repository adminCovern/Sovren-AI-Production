(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_989e45._.js", {

"[project]/src/lib/voice/AudioProcessor.ts [app-client] (ecmascript)": (({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, k: __turbopack_refresh__ }) => (() => {
"use strict";
...
"[project]/src/lib/voice/ExecutiveVoiceRouter.ts [app-client] (ecmascript)": (({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, k: __turbopack_refresh__ }) => (() => {
"use strict";
...
"[project]/src/lib/voice/SIPClient.ts [app-client] (ecmascript)": (({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, k: __turbopack_refresh__ }) => (() => {
"use strict";

__turbopack_esm__({
    "SIPClient": ()=>SIPClient
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sip$2e$js$2f$lib$2f$api$2f$user$2d$agent$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/sip.js/lib/api/user-agent.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sip$2e$js$2f$lib$2f$api$2f$inviter$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/sip.js/lib/api/inviter.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sip$2e$js$2f$lib$2f$api$2f$session$2d$state$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/sip.js/lib/api/session-state.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$voice$2f$AudioProcessor$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/lib/voice/AudioProcessor.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$voice$2f$ExecutiveVoiceRouter$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/lib/voice/ExecutiveVoiceRouter.ts [app-client] (ecmascript)");
...
class SIPClient {
    ...
    constructor(config, audioProcessor, voiceRouter){
        ...
        this.eventListeners = new Map();
        this.audioProcessor = audioProcessor || new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$voice$2f$AudioProcessor$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AudioProcessor"]();
        this.voiceRouter = voiceRouter || new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$voice$2f$ExecutiveVoiceRouter$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ExecutiveVoiceRouter"]();
        this.initializeEventListeners();
    }
    initializeEventListeners() {
    ...
    async initialize() {
        try {
            // Create User Agent
            const uri = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sip$2e$js$2f$lib$2f$api$2f$user$2d$agent$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UserAgent"].makeURI(this.config.uri);
            if (!uri) {
                throw new Error(`Failed to create valid URI from ${this.config.uri}`);
            }
            this.ua = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sip$2e$js$2f$lib$2f$api$2f$user$2d$agent$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UserAgent"]({
                uri: uri,
    ...
    async makeCall(targetUri, executiveId) {
        ...
        try {
            const target = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sip$2e$js$2f$lib$2f$api$2f$user$2d$agent$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UserAgent"].makeURI(targetUri);
            if (!target) {
                throw new Error(`Failed to create valid URI from ${targetUri}`);
            }
            const inviter = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sip$2e$js$2f$lib$2f$api$2f$inviter$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Inviter"](this.ua, target, {
            ...
            const callSession = {
                ...
                remoteUri: targetUri,
                state: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sip$2e$js$2f$lib$2f$api$2f$session$2d$state$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SessionState"].Initial,
                startTime: new Date(),
                duration: 0,
                isInbound: false
            };
    ...
    async handleIncomingCall(invitation) {
        ...
        try {
            ...
            callSession.state = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sip$2e$js$2f$lib$2f$api$2f$session$2d$state$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SessionState"].Established;
...
"[project]/src/lib/voice/VoiceSynthesizer.ts [app-client] (ecmascript)": (({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, k: __turbopack_refresh__ }) => (() => {
"use strict";

__turbopack_esm__({
    "VoiceSynthesizer": ()=>VoiceSynthesizer
});
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$voice$2f$StyleTTS2Engine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/lib/voice/StyleTTS2Engine.ts [app-client] (ecmascript)");
"__TURBOPACK__ecmascript__hoisting__location__";
;
class VoiceSynthesizer {
    ...
    async initialize() {
        ...
        try {
            ...
            this.styleTTS2Engine = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$voice$2f$StyleTTS2Engine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StyleTTS2Engine"](styleTTS2Config);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$voice$2f$SIPClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/lib/voice/SIPClient.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$voice$2f$AudioProcessor$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/lib/voice/AudioProcessor.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$voice$2f$ExecutiveVoiceRouter$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/lib/voice/ExecutiveVoiceRouter.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$voice$2f$VoiceSynthesizer$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/lib/voice/VoiceSynthesizer.ts [app-client] (ecmascript)");
"__TURBOPACK__ecmascript__hoisting__location__";
;
;
;
...
class VoiceSystemManager {
    ...
    constructor(config){
        ...
        this.audioProcessor = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$voice$2f$AudioProcessor$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AudioProcessor"](config.audio);
        this.voiceRouter = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$voice$2f$ExecutiveVoiceRouter$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ExecutiveVoiceRouter"]();
        this.voiceSynthesizer = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$voice$2f$VoiceSynthesizer$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VoiceSynthesizer"](config.synthesis);
        this.sipClient = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$voice$2f$SIPClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SIPClient"](config.sip, this.audioProcessor, this.voiceRouter);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$voice$2f$VoiceSystemManager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/lib/voice/VoiceSystemManager.ts [app-client] (ecmascript)");
"__TURBOPACK__ecmascript__hoisting__location__";
...
function useVoiceSystem(options = {}) {
    ...
    const [activeCalls, setActiveCalls] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [executives, setExecutives] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [availableExecutives, setAvailableExecutives] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    // Voice system manager instance
    const voiceSystemRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const eventCallbacksRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(new Map());
    // Initialize voice system
    const initialize = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        ...
        try {
            ...
            const voiceSystem = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$voice$2f$VoiceSystemManager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VoiceSystemManager"](config);
    ...
    const shutdown = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
    ...
    // Make a call
    const makeCall = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])(async (targetUri, executiveId, message)=>{
        if (!voiceSystemRef.current) {
            throw new Error('Voice system not initialized');
        }
    ...
    // End a call
    const endCall = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])(async (sessionId)=>{
        if (!voiceSystemRef.current) {
            throw new Error('Voice system not initialized');
        }
    ...
    const setExecutiveAvailability = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])((executiveId, availability)=>{
        if (!voiceSystemRef.current) {
            return;
        }
    ...
    const updateExecutivePosition = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])((executiveId, x, y, z)=>{
        if (!voiceSystemRef.current) {
            return;
        }
    ...
    // Speak as executive
    const speakAsExecutive = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])(async (executiveId, text, priority = 'normal')=>{
        if (!voiceSystemRef.current) {
            throw new Error('Voice system not initialized');
        }
    ...
    const onCallStarted = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])((callback)=>{
    ...
    const onCallEnded = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])((callback)=>{
    ...
    const onExecutiveAssigned = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])((callback)=>{
    ...
    const onAudioActivity = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])((callback)=>{
...
_s(useVoiceSystem, "E26x3yvD2KyXaQ2ZWrB80cZZO1I=");

})()),
"[project]/src/components/providers/Providers.tsx [app-client] (ecmascript)": (({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, k: __turbopack_refresh__ }) => (() => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useVoiceSystem$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/hooks/useVoiceSystem.ts [app-client] (ecmascript)");
"__TURBOPACK__ecmascript__hoisting__location__";
;
...
const VoiceSystemContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])(null);
function useVoiceSystemContext() {
    _s();
    const context = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(VoiceSystemContext);
    if (!context) {
        throw new Error('useVoiceSystemContext must be used within VoiceSystemProvider');
    }
    return context;
}
_s(useVoiceSystemContext, "b9L3QQ+jgeyIrH0NfHrJ8nn7VMU=");
function VoiceSystemProvider({ children }) {
    _s1();
    const voiceSystem = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useVoiceSystem$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useVoiceSystem"])({
        autoInitialize: true,
        config: {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(VoiceSystemContext.Provider, {
        value: voiceSystem,
        children: children
    }, void 0, false, {
...
_s1(VoiceSystemProvider, "B2/c/4X7S0ILnQfbUZnStmJkFa0=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useVoiceSystem$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useVoiceSystem"]
    ];
});
_c = VoiceSystemProvider;
function Providers({ children }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(VoiceSystemProvider, {
        children: children
    }, void 0, false, {
        fileName: "[project]/src/components/providers/Providers.tsx",
        lineNumber: 43,
...
_c1 = Providers;
var _c, _c1;
__turbopack_refresh__.register(_c, "VoiceSystemProvider");
__turbopack_refresh__.register(_c1, "Providers");
...
//# sourceMappingURL=src_989e45._.js.map